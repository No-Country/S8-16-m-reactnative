...
export const ProfileScreen = () => {
  return (
    ...
    <View className="flex-1 py-5 bg-bookBlack">
      ...
      <View className="flex flex-1 my-5" style={styles.booksContainer}>
        <Text className="text-bookWhite mb-10 pl-3 text-base">Libros publicados</Text>
        <ScrollView horizontal={true} className="flex flex-row gap-5 p-5 bg-bookDarkGrey">
            <View className="flex  rounded-xl p-3 bg-bookGrey" style={{width: 150, height: 250}}>
                <View style={styles.bookContainer} className="flex border-dashed border-2 border-bookWhite justify-center items-center">
      ...
      <View className="flex">
        <Text className="text-bookWhite mb-10 pl-3 text-base">Chat comenzados</Text>
