...
export const Register1: React.FC<FormularioProps> = ({ navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!querySnapshot.empty) {
      Alert.alert('Error', 'Ya existe un usuario registrado con ese nombre de usuario');
      console.log('Error', 'Ya existe un usuario registrado con ese nombre de usuario')
    } else {
