...
export const Register3: React.FC<Register3Props> = ({ navigation, route }) => {
  ...
  return (
    <View className="flex-1 justify-center items-center bg-[#1E1E1E]">
      ...
      ></Image>
      <Text className="text-[#FFFFFF] text-base mb-7 mt-5 text-center font-bold">
        ¡Listo!{'\n'}
        Una cosita mas
      </Text>
      <Text className="text-[#FFFFFF] text-base mb-16 text-center w-2/4">
        ¿Quéres publicar un libro o manga para vender o hacer truque?
      </Text>
